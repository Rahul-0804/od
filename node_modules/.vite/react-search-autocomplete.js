...
var INFINITY, INCORRECT_INDEX_TYPE, LOGICAL_SEARCH_INVALID_QUERY_FOR_KEY, PATTERN_LENGTH_TOO_LARGE, MISSING_KEY_PROPERTY, INVALID_KEY_WEIGHT_VALUE, hasOwn, KeyStore, MatchOptions, BasicOptions, FuzzyOptions, AdvancedOptions, Config, SPACE, FuseIndex, MAX_BITS, BitapSearch, BaseMatch, ExactMatch, InverseExactMatch, PrefixExactMatch, InversePrefixExactMatch, SuffixExactMatch, InverseSuffixExactMatch, FuzzyMatch, IncludeMatch, searchers, searchersLen, SPACE_RE, OR_TOKEN, MultiMatchSet, ExtendedSearch, registeredSearchers, LogicalOperator, KeyType, isExpression, isPath, isLeaf, convertToExplicit, Fuse, fuse_esm_default;
var init_fuse_esm = __esm({
  "node_modules/fuse.js/dist/fuse.esm.js"() {
    ...
    Config = __spreadValues(__spreadValues(__spreadValues(__spreadValues({}, BasicOptions), MatchOptions), FuzzyOptions), AdvancedOptions);
    SPACE = /[^ ]+/g;
    FuseIndex = class {
...
function mergeRecursively(origin, newComer, extensions) {
  if (!isPlainObject(newComer)) {
    if (extensions && isArray2(extensions)) {
...
var init_styled_components_browser_esm = __esm({
  "node_modules/styled-components/dist/styled-components.browser.esm.js"() {
    import_stylis = __toModule(require_stylis_min());
    import_stylis_rule_sheet = __toModule(require_stylis_rule_sheet());
    ...
    StyledComponentsError = function(_Error) {
      ...
      function StyledComponentsError2(code) {
        ...
        if (false) {
          ...
          var _this = possibleConstructorReturn(this, _Error.call(this, format2.apply(void 0, [ERRORS[code]].concat(interpolations)).trim()));
        }
...
var require_utils = __commonJS({
  "node_modules/react-search-autocomplete/dist/utils/utils.js"(exports) {
    ...
    var isCached = function isCached2(keyword) {
...
var require_SearchIcon = __commonJS({
  "node_modules/react-search-autocomplete/dist/components/SearchIcon.js"(exports) {
    ...
    var _styledComponents = _interopRequireDefault((init_styled_components_browser_esm(), styled_components_browser_esm_exports));
    var _templateObject;
    ...
    var SearchIcon = function SearchIcon2(_ref) {
      ...
      return _react.default.createElement(StyledSearchIcon, {
...
var require_Results = __commonJS({
  "node_modules/react-search-autocomplete/dist/components/Results.js"(exports) {
    ...
    var _react = _interopRequireDefault(require_react());
    var _styledComponents = _interopRequireDefault((init_styled_components_browser_esm(), styled_components_browser_esm_exports));
    var _SearchIcon = require_SearchIcon();
    var _templateObject;
    function _interopRequireDefault(obj) {
      return obj && obj.__esModule ? obj : { default: obj };
    }
    ...
    function Results(props) {
      var results = props.results, onClick = props.onClick, setSearchString = props.setSearchString, showIcon = props.showIcon, maxResults = props.maxResults, resultStringKeyName = props.resultStringKeyName, onHover = props.onHover, formatResult = props.formatResult;
      var formatResultWithKey = formatResult ? formatResult : function(val) {
        return val[resultStringKeyName];
      };
      var handleClick = function handleClick2(result) {
        onClick(result);
      ...
      return _react.default.createElement(StyledResults, null, _react.default.createElement("div", {
        className: "line"
...
var require_ClearIcon = __commonJS({
  "node_modules/react-search-autocomplete/dist/components/ClearIcon.js"(exports) {
    ...
    var ClearIcon = function ClearIcon2(_ref) {
      var showClear = _ref.showClear, setSearchString = _ref.setSearchString, searchString = _ref.searchString, setFocus = _ref.setFocus, onClear = _ref.onClear;
      var handleClearSearchString = function handleClearSearchString2() {
        setSearchString({
          target: {
            value: ""
          }
      ...
      return _react.default.createElement(StyledClearIcon, {
...
var require_SearchInput = __commonJS({
  "node_modules/react-search-autocomplete/dist/components/SearchInput.js"(exports) {
    ...
    var _SearchIcon = require_SearchIcon();
    var _styledComponents = _interopRequireDefault((init_styled_components_browser_esm(), styled_components_browser_esm_exports));
    var _ClearIcon = require_ClearIcon();
    var _templateObject;
    function _interopRequireDefault(obj) {
      return obj && obj.__esModule ? obj : { default: obj };
    }
    ...
    function SearchInput(_ref) {
      var searchString = _ref.searchString, setSearchString = _ref.setSearchString, autoFocus = _ref.autoFocus, onBlur = _ref.onBlur, onFocus = _ref.onFocus, onClear = _ref.onClear, placeholder = _ref.placeholder, showIcon = _ref.showIcon, showClear = _ref.showClear;
      var ref = (0, _react.useRef)();
      var manualFocus = true;
      var setFocus = function setFocus2() {
        manualFocus = false;
        ref.current.focus();
        manualFocus = true;
      };
      var handleOnFocus = function handleOnFocus2() {
        manualFocus && onFocus();
      };
      return _react.default.createElement(StyledSearchInput, null, _react.default.createElement(_SearchIcon.SearchIcon, {
        showIcon
        ...
        placeholder,
        autoFocus
      }), _react.default.createElement(_ClearIcon.ClearIcon, {
        showClear,
        setSearchString,
        searchString,
        onClear,
...
var require_ReactSearchAutocomplete = __commonJS({
  "node_modules/react-search-autocomplete/dist/components/ReactSearchAutocomplete.js"(exports) {
    ...
    var _fuse = _interopRequireDefault((init_fuse_esm(), fuse_esm_exports));
    var _propTypes = _interopRequireDefault(require_prop_types());
    var _react = _interopRequireWildcard(require_react());
    var _styledComponents = _interopRequireWildcard((init_styled_components_browser_esm(), styled_components_browser_esm_exports));
    var _config = require_config();
    var _utils = require_utils();
    var _Results = _interopRequireDefault(require_Results());
    var _SearchInput = _interopRequireDefault(require_SearchInput());
    var _templateObject;
    function _getRequireWildcardCache() {
      if (typeof WeakMap !== "function")
        return null;
    ...
    function ReactSearchAutocomplete(props) {
      var items = props.items, fuseOptions = props.fuseOptions, inputDebounce = props.inputDebounce, onSearch = props.onSearch, onHover = props.onHover, onSelect = props.onSelect, onFocus = props.onFocus, onClear = props.onClear, showIcon = props.showIcon, showClear = props.showClear, maxResults = props.maxResults, placeholder = props.placeholder, autoFocus = props.autoFocus, styling = props.styling, resultStringKeyName = props.resultStringKeyName, inputSearchString = props.inputSearchString, formatResult = props.formatResult;
      ...
      var _useState = (0, _react.useState)(inputSearchString), _useState2 = _slicedToArray(_useState, 2), searchString = _useState2[0], setSearchString = _useState2[1];
      var _useState3 = (0, _react.useState)(), _useState4 = _slicedToArray(_useState3, 2), results = _useState4[0], setResults = _useState4[1];
      var callOnSearch = function callOnSearch2(keyword) {
        var newResults = [];
      ...
      var handleOnClick = function handleOnClick2(result) {
        setResults([]);
        onSelect(result);
      };
      var fuseResults = function fuseResults2(keyword) {
      ...
      var handleSetSearchString = function handleSetSearchString2(_ref) {
      ...
      return _react.default.createElement(_styledComponents.ThemeProvider, {
        theme
      }, _react.default.createElement(StyledReactSearchAutocomplete, null, _react.default.createElement("div", {
        className: "wrapper"
...
var require_dist = __commonJS({
  "node_modules/react-search-autocomplete/dist/index.js"(exports) {
    ...
    var _ReactSearchAutocomplete = _interopRequireDefault(require_ReactSearchAutocomplete());
    function _interopRequireDefault(obj) {
      return obj && obj.__esModule ? obj : { default: obj };
    }
  }
