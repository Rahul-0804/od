...
a: {
  ...
  if (y) {
    Ha2 = Ba();
    if (Ha2 != null && Ha2 > parseFloat(Fa2)) {
      Ea = String(Ha2);
      break a;
    }
  }
      ...
      if (f) {
        ...
        for (var n = f.split("&"), u = 0; u < n.length; u++) {
          ...
          if (1 < m.length) {
            ...
            m = m[1];
            var F2 = r.split("_");
            h = 2 <= F2.length && F2[1] == "type" ? h + (r + "=" + m + "&") : h + (r + "=redacted&");
          }
        }
      } else
        h = null;
    ...
    if (a == this.g)
      a: {
        ...
        if (!(3 > r) && (r != 3 || ya || this.g && (this.h.h || this.g.fa() || hc(this.g)))) {
          this.I || r != 4 || b2 == 7 || (b2 == 8 || 0 >= F2 ? H(3) : H(2));
          ic(this);
          var c = this.g.aa();
          this.Y = c;
          b:
        ...
        for (e = c.Fa.g.parse(b2), b2 = 0; b2 < e.length; b2++) {
          ...
          if (c.G == 2)
            if (m[0] == "c") {
              ...
              const F2 = m[4];
              F2 != null && (c.Ca = F2, c.j.info("SVER=" + c.Ca));
              const Ca2 = m[5];
              Ca2 != null && typeof Ca2 === "number" && 0 < Ca2 && (d = 1.5 * Ca2, c.J = d, c.j.info("backChannelRequestTimeoutMs_=" + d));
              d = c;
              const Z2 = a.g;
              if (Z2) {
                ...
                if (Da2) {
                  var f = d.h;
                  f.g || Da2.indexOf("spdy") == -1 && Da2.indexOf("quic") == -1 && Da2.indexOf("h2") == -1 || (f.j = f.l, f.g = new Set(), f.h && (vc(f, f.h), f.h = null));
                }
                if (d.D) {
...
function U(a) {
  a.g || (a.g = new Map(), a.h = 0, a.i && Fc(a.i, function(b2, c) {
...
var Q2 = class {
  ...
  getToken() {
    ...
    return this.forceRefresh = false, this.auth ? this.auth.getToken(e).then((e2) => this.i !== t2 ? (C2("FirebaseAuthCredentialsProvider", "getToken aborted due to token change."), this.getToken()) : e2 ? (M2(typeof e2.accessToken == "string"), new q2(e2.accessToken, this.currentUser)) : null) : Promise.resolve(null);
  }
  invalidateToken() {
...
var j = class {
  constructor(t2, e, n, s) {
    this.h = t2, this.l = e, this.m = n, this.g = s, this.type = "FirstParty", this.user = P2.FIRST_PARTY, this.p = new Map();
  }
  I() {
...
function ft(t2, e) {
  ...
  for (let s = 0; s < Math.min(t2.fields.length, e.fields.length); ++s)
    if (n = _t(t2.fields[s], e.fields[s]), n !== 0)
      return n;
...
var bt = class {
  constructor(t2, e, n) {
    ...
    bt.D(getUA()) === 12.2 && x2("Firestore persistence suffers from a bug in iOS 12.2 Safari that may cause your app to stop working. See https://stackoverflow.com/q/56496296/110915 for details and a potential workaround.");
  }
  static delete(t2) {
  ...
  static N() {
    var t2;
    return typeof process != "undefined" && ((t2 = process.env) === null || t2 === void 0 ? void 0 : t2.O) === "YES";
  }
  static M(t2, e) {
    return t2.store(e);
  }
  ...
  async F(t2) {
    return this.db || (C2("SimpleDb", "Opening database:", this.name), this.db = await new Promise((e, n) => {
      ...
      s.onsuccess = (t3) => {
        ...
        s2.name === "VersionError" ? n(new L2(B2.FAILED_PRECONDITION, "A newer version of the Firestore SDK was previously used and so the persisted data is not compatible with the version of the SDK you are now using. The SDK will operate with persistence disabled. If you need persistence, please re-upgrade to a newer version of the SDK or else clear the persisted IndexedDB data for your app to start fresh.")) : s2.name === "InvalidStateError" ? n(new L2(B2.FAILED_PRECONDITION, "Unable to open an IndexedDB connection. This could be due to running in a private browsing session on a browser whose private browsing sessions do not support IndexedDB: " + s2)) : n(new vt(t2, s2));
...
var St = class {
  ...
  put(t2, e) {
    let n;
    return e !== void 0 ? (C2("SimpleDb", "PUT", this.store.name, t2, e), n = this.store.put(e, t2)) : (C2("SimpleDb", "PUT", this.store.name, "<auto-key>", t2), n = this.store.put(t2)), Dt(n);
  }
  add(t2) {
  ...
  get(t2) {
    return Dt(this.store.get(t2)).next((e) => (e === void 0 && (e = null), C2("SimpleDb", "GET", this.store.name, t2, e), e));
  }
  delete(t2) {
  ...
  H(t2, e) {
    ...
    return new At((s, i) => {
      t2.onerror = (t3) => {
        ...
        r.isDone ? s() : r.G === null ? i2.continue() : i2.continue(r.G);
      };
    }).next(() => At.waitFor(n));
  }
  options(t2, e) {
...
var kt = class {
  ...
  it(t2, e) {
    const n = new Set();
    let s = e, i = true;
    return At.doWhile(() => i === true && s > 0, () => this.localStore.indexManager.getNextCollectionGroupToUpdate(t2).next((e2) => {
      if (e2 !== null && !n.has(e2))
...
var Ut = class {
  constructor(t2, e, n, s, i) {
    this.key = t2, this.value = e, this.color = n != null ? n : Ut.RED, this.left = s != null ? s : Ut.EMPTY, this.right = i != null ? i : Ut.EMPTY, this.size = this.left.size + 1 + this.right.size;
  }
  copy(t2, e, n, s, i) {
    return new Ut(t2 != null ? t2 : this.key, e != null ? e : this.value, n != null ? n : this.color, s != null ? s : this.left, i != null ? i : this.right);
  }
  isEmpty() {
    return false;
  }
...
function re(t2) {
  return typeof t2 == "number" && Number.isInteger(t2) && !ie(t2) && t2 <= Number.MAX_SAFE_INTEGER && t2 >= Number.MIN_SAFE_INTEGER;
}
var oe = {
  mapValue: {
    fields: {
    ...
    case 10:
      return function(t3, e2) {
        ...
        if (Mt(n2) !== Mt(s))
          return false;
        for (const t4 in n2)
          if (n2.hasOwnProperty(t4) && (s[t4] === void 0 || !ae(n2[t4], s[t4])))
            return false;
        return true;
      }(t2, e);
    default:
...
function he(t2, e) {
  return (t2.values || []).find((t3) => ae(t3, e)) !== void 0;
}
function le(t2, e) {
  if (t2 === e)
    return 0;
...
var Be = class extends class {
  ...
  static create(t2, e, n) {
    return t2.isKeyField() ? e === "in" || e === "not-in" ? this.lt(t2, e, n) : new Le(t2, e, n) : e === "array-contains" ? new Ge(t2, n) : e === "in" ? new Qe(t2, n) : e === "not-in" ? new je(t2, n) : e === "array-contains-any" ? new We(t2, n) : new Be(t2, e, n);
  }
  static lt(t2, e, n) {
    return e === "in" ? new Ue(t2, n) : new qe(t2, n);
  }
  matches(t2) {
    const e = t2.data.field(this.field);
    return this.op === "!=" ? e !== null && this.ft(le(e, this.value)) : e !== null && ce(this.value) === ce(e) && this.ft(le(e, this.value));
  }
  ft(t2) {
    switch (this.op) {
      case "<":
...
var Qe = class extends Be {
  ...
  matches(t2) {
    const e = t2.data.field(this.field);
    return e !== null && he(this.value.arrayValue, e);
  }
};
...
function mn(t2, e, n) {
  const s = t2.field.isKeyField() ? ct.comparator(e.key, n.key) : function(t3, e2, n2) {
    ...
    return s2 !== null && i !== null ? le(s2, i) : O2();
  }(t2.field, e, n);
  switch (t2.dir) {
    case "asc":
      return s;
...
function Ln(t2, e, n, s) {
  return t2 instanceof Kn ? function(t3, e2, n2, s2) {
    ...
    if (r.setAll(Qn(t3)), r.setAll(i), e2.convertToFoundDocument(e2.version, r).setHasLocalMutations(), n2 === null)
      return null;
...
function qn(t2, e) {
  return t2.type === e.type && (!!t2.key.isEqual(e.key) && (!!t2.precondition.isEqual(e.precondition) && (!!function(t3, e2) {
    return t3 === void 0 && e2 === void 0 || !(!t3 || !e2) && tt(t3, e2, (t4, e3) => Nn(t4, e3));
...
var Ts = class {
  constructor(t2) {
    this.Bt = t2, this.Lt = new Map(), this.Ut = ss(), this.qt = Es(), this.Kt = new qt(Z);
  }
  Gt(t2) {
    ...
    this.Lt.forEach((n2, s2) => {
      ...
      if (i) {
        if (n2.current && Oe(i.target)) {
          ...
          this.Ut.get(e2) !== null || this.ee(s2, e2) || this.jt(s2, e2, Se.newNoDocument(e2, t2));
        }
...
function Ms(t2) {
  const e = xs(t2);
  return e.length === 4 ? rt.emptyPath() : $s(e);
}
function Fs(t2) {
...
function qs(t2, e) {
  ...
  if ("targetChange" in e) {
    ...
    const s = function(t3) {
      ...
      return t3.gt ? (M2(e2 === void 0 || typeof e2 == "string"), Wt.fromBase64String(e2 || "")) : (M2(e2 === void 0 || e2 instanceof Uint8Array), Wt.fromUint8Array(e2 || new Uint8Array()));
    }(t2, e.targetChange.resumeToken), o = e.targetChange.cause, u = o && function(t3) {
      const e2 = t3.code === void 0 ? B2.UNKNOWN : ts(t3.code);
...
function Gs(t2, e) {
  const n = e.currentDocument ? function(t3) {
    return t3.updateTime !== void 0 ? On.updateTime(Ds(t3.updateTime)) : t3.exists !== void 0 ? On.exists(t3.exists) : On.none();
  }(e.currentDocument) : On.none(), s = e.updateTransforms ? e.updateTransforms.map((e2) => function(t3, e3) {
    let n2 = null;
    if ("setToServerValue" in e3)
      M2(e3.setToServerValue === "REQUEST_TIME"), n2 = new Rn();
...
function Ws(t2, e) {
  ...
  e.collectionGroup !== null ? (n.parent = Os(t2, s), n.structuredQuery.from = [{
...
function zs(t2) {
  ...
  n.orderBy && (o = n.orderBy.map((t3) => function(t4) {
    return new He(ti(t4.field), function(t5) {
      switch (t5) {
        case "ASCENDING":
          return "asc";
        case "DESCENDING":
  ...
  n.limit && (u = function(t3) {
    let e2;
    return e2 = typeof t3 == "object" ? t3.value : t3, se(e2) ? null : e2;
  }(n.limit));
  let c = null;
...
function Js(t2) {
  return t2 ? t2.unaryFilter !== void 0 ? [ni(t2)] : t2.fieldFilter !== void 0 ? [ei(t2)] : t2.compositeFilter !== void 0 ? t2.compositeFilter.filters.map((t3) => Js(t3)).reduce((t3, e) => t3.concat(e)) : O2() : [];
}
function Ys(t2) {
  return Rs[t2];
}
...
function Qi(t2) {
  const e = Ki(t2.readTime), n = t2.lastLimboFreeSnapshotVersion !== void 0 ? Ki(t2.lastLimboFreeSnapshotVersion) : st.min();
  let s;
  var i;
  return t2.query.documents !== void 0 ? (M2((i = t2.query).documents.length === 1), s = cn(en(Ms(i.documents[0])))) : s = function(t3) {
    return cn(zs(t3));
...
function Wi(t2) {
  ...
  return t2.limitType === "LAST" ? an(e, e.limit, "L") : e;
}
function zi(t2, e) {
...
var tr = class {
  ...
  getOverlaysForCollection(t2, e, n) {
    const s = us(), i = ri(e), r = IDBKeyRange.bound([this.userId, i, n], [this.userId, i, Number.POSITIVE_INFINITY], true);
...
var nr = class {
  ...
  ae(t2, e) {
    if ("nullValue" in t2)
      ...
      this.le(e, 20), typeof n == "string" ? e.de(n) : (e.de(`${n.seconds || ""}`), e.fe(n.nanos || 0));
...
var rr = class {
  ...
  Ae(t2) {
    const e = 255 & t2;
    e === 0 ? (this.Oe(0), this.Oe(255)) : e === 255 ? (this.Oe(255), this.Oe(0)) : this.Oe(e);
  }
  Pe(t2) {
    const e = 255 & t2;
    e === 0 ? (this.Fe(0), this.Fe(255)) : e === 255 ? (this.Fe(255), this.Fe(0)) : this.Fe(t2);
  }
  Re() {
    this.Oe(0), this.Oe(1);
  }
...
function hr(t2, e) {
  ...
  return n !== 0 ? n : (n = lr(t2.arrayValue, e.arrayValue), n !== 0 ? n : (n = lr(t2.directionalValue, e.directionalValue), n !== 0 ? n : ct.comparator(t2.documentKey, e.documentKey)));
}
function lr(t2, e) {
...
var fr = class {
  constructor(t2) {
    this.collectionId = t2.collectionGroup != null ? t2.collectionGroup : t2.path.lastSegment(), this.Ge = t2.orderBy, this.Qe = [];
    for (const e of t2.filters) {
      const t3 = e;
...
var mr = class {
        ...
        return At.forEach(i, (i2, r) => {
          ...
          const u = function(t4, e2) {
            ...
            for (const i3 of lt(e2)) {
              const e3 = i3.kind === 0 ? Fe(t4, i3.fieldPath, t4.startAt) : $e(t4, i3.fieldPath, t4.startAt);
            ...
            let s3 = true;
            for (const i3 of lt(e2)) {
              const e3 = i3.kind === 0 ? $e(t4, i3.fieldPath, t4.endAt) : Fe(t4, i3.fieldPath, t4.endAt);
              n2.push(e3.value), s3 && (s3 = e3.inclusive);
            }
            return new ze(n2, s3);
  ...
  rn(t2, e, n, s, i, r, o) {
    ...
    for (let h = 0; h < u; ++h) {
      const u2 = e ? this.on(e[h / c]) : wr, l2 = this.un(t2, u2, n[h % c], s), f = this.cn(t2, u2, i[h % c], r), d = o.map((e2) => this.un(t2, u2, e2, true));
  ...
  en(t2, e) {
    const n = new fr(e), s = e.collectionGroup != null ? e.collectionGroup : e.path.lastSegment();
  ...
  ln(t2, e) {
    return !!t2.filters.find((t3) => t3 instanceof Be && t3.field.isEqual(e) && (t3.op === "in" || t3.op === "not-in"));
  }
  getFieldIndexes(t2, e) {
  ...
  getNextCollectionGroupToUpdate(t2) {
    return this.getFieldIndexes(t2).next((t3) => t3.length === 0 ? null : (t3.sort((t4, e) => {
      ...
      return n !== 0 ? n : Z(t4.collectionGroup, e.collectionGroup);
  ...
  createRange(t2, e, n) {
    n = n.sort((t3, e2) => hr(t3, e2)).filter((t3, e2, n2) => !e2 || hr(t3, n2[e2 - 1]) !== 0);
    const s = [];
    s.push(t2);
    for (const i2 of n) {
...
var xr = class {
  ...
  Vn(t2) {
    return kr(t2).get("targetGlobalKey").next((t3) => (M2(t3 !== null), t3));
  }
  Sn(t2, e) {
  ...
  removeMatchingKeysForTargetId(t2, e) {
    const n = Or(t2), s = IDBKeyRange.bound([e], [e + 1], false, true);
    return n.delete(s);
  }
  getMatchingKeysForTargetId(t2, e) {
    const n = IDBKeyRange.bound([e], [e + 1], false, true), s = Or(t2);
    let i = fs();
    return s.Z({
      range: n,
      X: true
  ...
  containsKey(t2, e) {
    const n = ri(e.path), s = IDBKeyRange.bound([n], [et(n)], false, true);
    let i = 0;
    return Or(t2).Z({
...
var Lr = class {
  ...
  Kn(t2, e) {
    ...
    return n.Z({
      ...
      t3 === 0 ? (i !== Ot.at && e(new ct(ci(s)), i), i = o, s = r) : i = Ot.at;
    }).next(() => {
...
function Ur(t2, e) {
  return Or(t2).put(function(t3, e2) {
    return {
      targetId: 0,
      path: ri(t3.path),
      sequenceNumber: e2
...
var Kr = class {
  ...
  removeEntry(t2, e, n) {
    return Wr(t2).delete(function(t3, e2) {
...
var Xr = class {
  ...
  getDocument(t2, e) {
    let n = null;
    return this.documentOverlayCache.getOverlay(t2, e).next((s) => (n = s, this.getBaseDocument(t2, e, n))).next((t3) => (n !== null && Ln(n.mutation, t3, Qt.empty(), nt.now()), t3));
  }
  getDocuments(t2, e) {
  ...
  computeViews(t2, e, n, s) {
    ...
    return e.forEach((t3, e2) => {
      ...
      s.has(e2.key) && (o2 === void 0 || o2.mutation instanceof Gn) ? i = i.insert(e2.key, e2) : o2 !== void 0 && (r.set(e2.key, o2.mutation.getFieldMask()), Ln(o2.mutation, e2, o2.mutation.getFieldMask(), nt.now()));
    }), this.recalculateAndSaveOverlays(t2, i).next((t3) => (t3.forEach((t4, e2) => r.set(t4, e2)), e.forEach((t4, e2) => {
      var n2;
      return o.set(t4, new Yr(e2, (n2 = r.get(t4)) !== null && n2 !== void 0 ? n2 : null));
    }), o));
  }
  ...
  getDocumentsMatchingCollectionGroupQuery(t2, e, n) {
    ...
    return this.indexManager.getCollectionParents(t2, s).next((r) => At.forEach(r, (r2) => {
      const o = function(t3, e2) {
        return new Ze(e2, null, t3.explicitOrderBy.slice(), t3.filters.slice(), t3.limit, t3.limitType, t3.startAt, t3.endAt);
      }(e, r2.child(s));
  ...
  getDocumentsMatchingCollectionQuery(t2, e, n) {
    ...
    return this.remoteDocumentCache.getAllFromCollection(t2, e.path, n).next((i) => (s = i, this.documentOverlayCache.getOverlaysForCollection(t2, e.path, n.largestBatchId))).next((t3) => {
      t3.forEach((t4, e2) => {
        const n3 = e2.getKey();
        s.get(n3) === null && (s = s.insert(n3, Se.newInvalidDocument(n3)));
      });
      let n2 = rs();
      return s.forEach((s2, i) => {
        const r = t3.get(s2);
        r !== void 0 && Ln(r.mutation, i, Qt.empty(), nt.now()), dn(e, i) && (n2 = n2.insert(s2, i));
      }), n2;
    });
  }
  getBaseDocument(t2, e, n) {
    return n === null || n.mutation.type === 1 ? this.remoteDocumentCache.getEntry(t2, e) : At.resolve(Se.newInvalidDocument(e));
  }
};
var Zr = class {
  constructor(t2) {
    this.It = t2, this.Zn = new Map(), this.ts = new Map();
  }
  getBundleMetadata(t2, e) {
...
var to = class {
  ...
  getOverlaysForCollectionGroup(t2, e, n, s) {
    ...
    for (; r.hasNext(); ) {
      ...
      if (t3.getKey().getCollectionGroup() === e && t3.largestBatchId > n) {
        ...
        e2 === null && (e2 = us(), i = i.insert(t3.largestBatchId, e2)), e2.set(t3.getKey(), t3);
      }
    }
  ...
  ue(t2, e, n) {
    ...
    let i = this.es.get(e);
    i === void 0 && (i = fs(), this.es.set(e, i)), this.es.set(e, i.add(n.key));
  }
};
var eo = class {
  constructor() {
  ...
  zs(t2, e) {
    ...
    return n.W().next((t3) => {
      ...
      return t3.forEach((t4) => {
        var e2;
        let s2 = (e2 = n2.get(t4.userId)) !== null && e2 !== void 0 ? e2 : fs();
...
var _o = class {
  constructor(t2, e, n, s, i, r, o, u, c, a, h = 15) {
    ...
    this.referenceDelegate = new Lr(this, s), this.ii = e + "main", this.It = new $i(u), this.ri = new bt(this.ii, this.Xs, new ho(this.It)), this.Cs = new xr(this.referenceDelegate, this.It), this.remoteDocumentCache = Gr(this.It), this.Ns = new Yi(), this.window && this.window.localStorage ? this.oi = this.window.localStorage : (this.oi = null, a === false && x2("IndexedDbPersistence", "LocalStorage is unavailable. As a result, persistence may not work reliably. In particular enablePersistence() could fail immediately after refreshing the page."));
  }
  start() {
    return this.ui().then(() => {
  ...
  async yi() {
    if (this.isPrimary && !this.pi(this.ni, 18e5)) {
      ...
      const t2 = await this.runTransaction("maybeGarbageCollectMultiClientState", "readwrite-primary", (t3) => {
        ...
        return e.W().next((t4) => {
          const n = this.Ii(t4, 18e5), s = t4.filter((t5) => n.indexOf(t5) === -1);
  ...
  di(t2) {
    ...
    return wo(t2).get("owner").next((e) => {
      if (e !== null && this.pi(e.leaseTimestampMs, 5e3) && !this.Ei(e.ownerId)) {
      ...
      return !(!this.networkEnabled || !this.inForeground) || mo(t2).W().next((t3) => this.Ii(t3, 5e3).find((t4) => {
  ...
  runTransaction(t2, e, n) {
    ...
    const s = e === "readonly" ? "readonly" : "readwrite", i = (r = this.Xs) === 15 ? Ci : r === 14 ? Di : r === 13 ? Si : r === 12 ? Vi : r === 11 ? vi : void O2();
    var r;
    let o;
    return this.ri.runTransaction(t2, s, i, (s2) => (o = new xi(s2, this.Ss ? this.Ss.next() : Ot.at), e === "readwrite-primary" ? this.fi(o).next((t3) => !!t3 || this.di(o)).next((e2) => {
      if (!e2)
  ...
  Vi(t2) {
    return wo(t2).get("owner").next((t3) => {
      if (t3 !== null && this.pi(t3.leaseTimestampMs, 5e3) && !this.Ei(t3.ownerId) && !this.mi(t3) && !(this.Ys || this.allowTabSynchronization && t3.allowTabSynchronization))
        throw new L2(B2.FAILED_PRECONDITION, fo);
    });
  }
  wi(t2) {
  ...
  ai() {
    var t2;
    typeof ((t2 = this.window) === null || t2 === void 0 ? void 0 : t2.addEventListener) == "function" && (this.Zs = () => {
  ...
  Ei(t2) {
    var e;
    try {
      const n = ((e = this.oi) === null || e === void 0 ? void 0 : e.getItem(this.Ti(t2))) !== null;
...
var po = class {
  ...
  ki(t2, e) {
    if (nn(e))
      return At.resolve(null);
    let n = cn(e);
    return this.indexManager.getIndexType(t2, n).next((s) => s === 0 ? null : (e.limit !== null && s === 1 && (e = an(e, null, "F"), n = cn(e)), this.indexManager.getDocumentsMatchingTarget(t2, n).next((s2) => {
      const i = fs(...s2);
...
var Io = class {
  constructor(t2, e, n, s) {
    this.persistence = t2, this.Li = e, this.It = s, this.Ui = new Bt(Z), this.qi = new es((t3) => xe(t3), ke), this.Ki = new Map(), this.Gi = t2.getRemoteDocumentCache(), this.Cs = t2.getTargetCache(), this.Ns = t2.getBundleCache(), this.Qi(n);
  }
  Qi(t2) {
...
function Vo(t2, e) {
  ...
  return n.persistence.runTransaction("Allocate target", "readwrite", (t3) => {
    ...
    return (s === null || t3.snapshotVersion.compareTo(s.snapshotVersion) > 0) && (n.Ui = n.Ui.insert(t3.targetId, t3), n.qi.set(e, t3.targetId)), t3;
  });
}
...
function Do(t2, e, n) {
  ...
  return s.persistence.runTransaction("Execute query", "readonly", (t3) => function(t4, e2, n2) {
    ...
    return i2 !== void 0 ? At.resolve(s2.Ui.get(i2)) : s2.Cs.getTargetData(e2, n2);
  }(s, t3, cn(e)).next((e2) => {
    if (e2)
...
function xo(t2, e) {
  ...
  return n.persistence.runTransaction("Get new document changes", "readonly", (t3) => n.Gi.getAllFromCollectionGroup(t3, e, mt(s, -1), Number.MAX_SAFE_INTEGER)).then((t3) => (No(n, e, t3), t3));
}
function No(t2, e, n) {
...
var Bo = class {
  ...
  static Zi(t2, e, n) {
    ...
    return r && s.error && (r = typeof s.error.message == "string" && typeof s.error.code == "string", r && (i = new L2(s.error.code, s.error.message))), r ? new Bo(t2, e, s.state, i) : (x2("SharedClientState", `Failed to parse mutation state for ID '${e}': ${n}`), null);
  }
  tr() {
    const t2 = {
      state: this.state,
...
var Lo = class {
  ...
  static Zi(t2, e) {
    ...
    return i && n.error && (i = typeof n.error.message == "string" && typeof n.error.code == "string", i && (s = new L2(n.error.code, n.error.message))), i ? new Lo(t2, n.state, s) : (x2("SharedClientState", `Failed to parse target state for ID '${t2}': ${e}`), null);
  }
  tr() {
    const t2 = {
      state: this.state,
...
var Uo = class {
  ...
  static Zi(t2, e) {
    const n = JSON.parse(e);
    let s = typeof n == "object" && n.activeTargetIds instanceof Array, i = _s();
...
var qo = class {
  ...
  static Zi(t2) {
    ...
    return typeof e == "object" && ["Unknown", "Online", "Offline"].indexOf(e.onlineState) !== -1 && typeof e.clientId == "string" ? new qo(e.clientId, e.onlineState) : (x2("SharedClientState", `Failed to parse online state: ${t2}`), null);
  }
};
var Ko = class {
  constructor() {
...
var Go = class {
  ...
  Dr(t2, e) {
    const n = this.dr.exec(t2), s = Number(n[1]), i = n[2] !== void 0 ? n[2] : null;
...
var eu = class {
  ...
  async close(t2, e) {
    this.Lo(), this.Uo(), this.xo.cancel(), this.So++, t2 !== 4 ? this.xo.reset() : e && e.code === B2.RESOURCE_EXHAUSTED ? (x2(e.toString()), x2("Using maximum backoff delay to prevent overloading the backend."), this.xo.Ao()) : e && e.code === B2.UNAUTHENTICATED && this.state !== 3 && (this.authCredentialsProvider.invalidateToken(), this.appCheckCredentialsProvider.invalidateToken()), this.stream !== null && (this.qo(), this.stream.close(), this.stream = null), this.state = t2, await this.listener.Zr(e);
  }
  qo() {
  }
  auth() {
...
var uu = class {
  constructor(t2, e, n, s, i) {
    this.localStore = t2, this.datastore = e, this.asyncQueue = n, this.remoteSyncer = {}, this.fu = [], this.du = new Map(), this._u = new Set(), this.wu = [], this.mu = i, this.mu.qr((t3) => {
...
function lu(t2, e) {
  const n = $(t2), s = ku(n);
  n.du.delete(e), s.ko() && du(n, e), n.du.size === 0 && (s.ko() ? s.Fo() : mu(n) && n.gu.set("Unknown"));
}
function fu(t2, e) {
...
async function Iu(t2, e, n) {
  if (t2.gu.set("Online"), e instanceof ps && e.state === 2 && e.cause)
    try {
...
var Lu = class {
  ...
  static fromInitialDocuments(t2, e, n, s, i) {
    ...
    }), new Lu(t2, e, $u.emptySet(e), r, n, s, true, false, i);
  }
  get hasPendingWrites() {
...
var qu = class {
  constructor() {
    this.queries = new es((t2) => ln(t2), hn), this.onlineState = "Unknown", this.Ru = new Set();
  }
};
  ...
  Pu(t2) {
    if (!this.options.includeMetadataChanges) {
      ...
      for (const n of t2.docChanges)
        n.type !== 3 && e2.push(n);
      t2 = new Lu(t2.query, t2.docs, t2.oldDocs, e2, t2.mutatedKeys, t2.fromCache, t2.syncStateChanged, true, t2.hasCachedResults);
    }
    let e = false;
...
var Yu = class {
  constructor(t2, e, n) {
    this.Mu = t2, this.localStore = e, this.It = n, this.queries = [], this.documents = [], this.collectionGroups = new Set(), this.progress = Xu(t2);
  }
  Fu(t2) {
...
var ec2 = class {
  ...
  applyChanges(t2, e, n) {
    ...
    if (this.qu = o, i.length !== 0 || u) {
      return {
        snapshot: new Lu(this.query, t2.Qu, s, i, t2.mutatedKeys, o === 0, u, false, !!n && n.resumeToken.approximateByteSize() > 0),
        Xu: r
      };
    }
    return {
  ...
  ec() {
    return Lu.fromInitialDocuments(this.query, this.Qu, this.mutatedKeys, this.qu === 0, this.hasCachedResults);
  }
};
var nc2 = class {
  constructor(t2, e, n) {
...
var ic2 = class {
  constructor(t2, e, n, s, i, r) {
    this.localStore = t2, this.remoteStore = e, this.eventManager = n, this.sharedClientState = s, this.currentUser = i, this.maxConcurrentLimboResolutions = r, this.sc = {}, this.ic = new es((t3) => ln(t3), hn), this.rc = new Map(), this.oc = new Set(), this.uc = new Bt(ct.comparator), this.cc = new Map(), this.ac = new eo(), this.hc = {}, this.lc = new Map(), this.fc = Cr.vn(), this.onlineState = "Unknown", this.dc = void 0;
  }
  get isPrimaryClient() {
    return this.dc === true;
  }
...
async function rc2(t2, e) {
  ...
  if (r)
    ...
    s = t3.targetId, i = await oc2(n, e, s, r2 === "current", t3.resumeToken);
  }
  return i;
}
async function oc2(t2, e, n, s, i) {
  t2._c = (e2, n2, s2) => async function(t3, e3, n3, s3) {
    ...
    i2.$i && (i2 = await Do(t3.localStore, e3.query, false).then(({ documents: t4 }) => e3.view.Wu(t4, i2)));
  ...
  const r = await Do(t2.localStore, e, true), o = new ec2(e, r.Hi), u = o.Wu(r.documents), c = ms.createSynthesizedTargetChangeForCurrentChange(n, s && t2.onlineState !== "Offline", i), a = o.applyChanges(u, t2.isPrimaryClient, c);
  pc2(t2, n, a.Xu);
...
async function uc2(t2, e) {
  ...
  if (n.isPrimaryClient) {
    ...
    n.sharedClientState.isActiveQueryTarget(s.targetId) || await So(n.localStore, s.targetId, false).then(() => {
      n.sharedClientState.clearQueryState(s.targetId), lu(n.remoteStore, s.targetId), gc2(n, s.targetId);
    }).catch(Et);
  } else
    gc2(n, s.targetId), await So(n.localStore, s.targetId, true);
}
      ...
      return n2.persistence.runTransaction("Locally write mutations", "readwrite", (t5) => {
        ...
        return n2.Gi.getEntries(t5, i).next((t6) => {
          ...
          for (const t6 of e2) {
            ...
            e3 != null && o2.push(new Gn(t6.key, e3, Ve(e3.value.mapValue), On.exists(true)));
          }
...
async function lc2(t2, e, n) {
  ...
  if (r) {
    ...
    const n2 = fs().add(r), i2 = new ws(st.min(), new Map(), new qt(Z), t3, n2);
    await ac2(s, i2), s.uc = s.uc.remove(r), s.cc.delete(e), Tc2(s);
  } else
    await So(s.localStore, e, false).then(() => gc2(s, e, n)).catch(Et);
}
...
function yc2(t2, e) {
  ...
  const n = t2.uc.get(e);
  n !== null && (lu(t2.remoteStore, n), t2.uc = t2.uc.remove(e), t2.cc.delete(n), Tc2(t2));
}
function pc2(t2, e, n) {
  for (const s of n)
    if (s instanceof Zu)
...
async function bc2(t2, e) {
  const n = $(t2), s = await Do(n.localStore, e.query, true), i = e.view.tc(s);
...
async function vc2(t2, e, n, s) {
  ...
  r !== null ? (n === "pending" ? await Au(i.remoteStore) : n === "acknowledged" || n === "rejected" ? (mc2(i, e, s || null), wc2(i, e), function(t3, e2) {
...
async function Vc2(t2, e) {
  const n = $(t2);
  if (kc2(n), Oc2(n), e === true && n.dc !== true) {
    const t3 = n.sharedClientState.getAllActiveQueryTargets(), e2 = await Sc2(n, t3.toArray());
    n.dc = true, await Nu(n.remoteStore, true);
    for (const t4 of e2)
      hu(n.remoteStore, t4);
  } else if (e === false && n.dc !== false) {
    const t3 = [];
    let e2 = Promise.resolve();
    n.rc.forEach((s, i) => {
      n.sharedClientState.isLocalQueryTarget(i) ? t3.push(i) : e2 = e2.then(() => (gc2(n, i), So(n.localStore, i, true))), lu(n.remoteStore, i);
    }), await e2, await Sc2(n, t3), function(t4) {
      const e3 = $(t4);
      e3.cc.forEach((t5, n2) => {
        lu(e3.remoteStore, n2);
      }), e3.ac.fs(), e3.cc = new Map(), e3.uc = new Bt(ct.comparator);
...
async function Sc2(t2, e, n) {
  ...
  for (const t3 of e) {
    ...
    if (n2 && n2.length !== 0) {
      ...
      e2 = await Vo(s.localStore, n3), await oc2(s, Dc2(n3), t3, false, e2.resumeToken);
    }
    i.push(e2);
  }
  return s.sc.Wo(r), i;
...
async function xc2(t2, e, n, s) {
  ...
  if (r && r.length > 0)
    switch (n) {
      case "current":
      case "not-current": {
        const t3 = await xo(i.localStore, _n(r[0])), s2 = ws.createSynthesizedRemoteEventForCurrentChange(e, n === "current", Wt.EMPTY_BYTE_STRING);
        await Ec2(i, t3, s2);
        break;
      }
      case "rejected":
        await So(i.localStore, e, true), gc2(i, e, s);
        break;
      default:
        O2();
    }
...
async function Nc2(t2, e, n) {
  ...
  if (s.dc) {
    for (const t3 of e) {
      ...
      await oc2(s, Dc2(e2), n2.targetId, false, n2.resumeToken), hu(s.remoteStore, n2);
    }
    for (const t3 of n)
      s.rc.has(t3) && await So(s.localStore, t3, false).then(() => {
...
function Mc2(t2, e, n) {
  ...
  (async function(t3, e2, n2) {
    try {
      ...
      return await Ec2(t3, o.Lu, void 0), await function(t4, e3) {
        const n3 = $(t4);
      ...
      return N2("SyncEngine", `Loading bundle failed with ${t4}`), n2._failWith(t4), Promise.resolve(new Set());
    }
  })(s, e, n).then((t3) => {
...
var $c2 = class extends Fc2 {
  ...
  yc(t2) {
    const e = go(t2.databaseInfo.databaseId, t2.databaseInfo.persistenceKey), n = this.cacheSizeBytes !== void 0 ? Ar.withCacheSize(this.cacheSizeBytes) : Ar.DEFAULT;
...
var Lc2 = class {
  async initialize(t2, e) {
    this.localStore || (this.localStore = t2.localStore, this.sharedClientState = t2.sharedClientState, this.datastore = this.createDatastore(e), this.remoteStore = this.createRemoteStore(e), this.eventManager = this.createEventManager(e), this.syncEngine = this.createSyncEngine(e, !t2.synchronizeTabs), this.sharedClientState.onlineStateHandler = (t3) => hc2(this.syncEngine, t3, 1), this.remoteStore.remoteSyncer.handleCredentialChange = Ac2.bind(null, this.syncEngine), await Nu(this.remoteStore, this.syncEngine.isPrimaryClient));
  }
...
var Jc2 = class {
  ...
  _setSettings(t2) {
    ...
    this._settings = new Hc2(t2), t2.credentials !== void 0 && (this._authCredentials = function(t3) {
      if (!t3)
        return new K2();
      switch (t3.type) {
        case "gapi":
...
var ta2 = class extends Zc2 {
  ...
  get parent() {
    ...
    return t2.isEmpty() ? null : new Xc2(this.firestore, null, new ct(t2));
  }
  withConverter(t2) {
...
function ea2(t2, e, ...n) {
  ...
  }
  {
    ...
    return Gc2(s), new ta2(t2.firestore, null, s);
  }
}
function na2(t2, e) {
  ...
  return new Zc2(t2, null, function(t3) {
    return new Ze(rt.emptyPath(), t3);
  }(e));
}
function sa2(t2, e, ...n) {
  if (t2 = getModularInstance(t2), arguments.length === 1 && (e = X2.R()), Uc2("doc", "path", e), t2 instanceof Jc2) {
    const s = rt.fromString(e, ...n);
    return Kc2(s), new Xc2(t2, null, new ct(s));
  }
  {
    if (!(t2 instanceof Xc2 || t2 instanceof ta2))
      throw new L2(B2.INVALID_ARGUMENT, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
  ...
  constructor(t2, e) {
    this.Pc = t2, this.It = e, this.metadata = new U2(), this.buffer = new Uint8Array(), this.vc = new TextDecoder("utf-8"), this.Vc().then((t3) => {
      t3 && t3.Ou() ? this.metadata.resolve(t3.ku.metadata) : this.metadata.reject(new Error(`The first element of the bundle is not a metadata, it is
             ${JSON.stringify(t3 == null ? void 0 : t3.ku)}`));
...
var la2 = class {
  ...
  run() {
    return ru(this.datastore, this.query._query).then((t2) => {
      M2(t2[0] !== void 0);
      const e = Object.entries(t2[0]).filter(([t3, e2]) => t3 === "count_alias").map(([t3, e2]) => this.userDataWriter.convertValue(e2))[0];
      return M2(typeof e == "number"), Promise.resolve(new ha2(this.query, {
        count: e
      }));
    });
  }
...
var fa2 = class {
  ...
  async lookup(t2) {
    ...
    const e = await async function(t3, e2) {
      ...
      }, r = await n._o("BatchGetDocuments", s, i, e2.length), o = new Map();
      r.forEach((t4) => {
        const e3 = Us(n.It, t4);
...
var da2 = class {
  ...
  $c(t2) {
    if (t2.name === "FirebaseError") {
      const e = t2.code;
      return e === "aborted" || e === "failed-precondition" || !Zn(e);
    }
    return false;
  }
};
...
function Sa2(t2, e) {
  ...
  return t2.asyncQueue.enqueueAndForget(async () => async function(t3, e2, n2) {
    try {
      const s = await Do(t3, e2, true), i = new ec2(e2, s.Hi), r = i.Wu(s.documents), o = i.applyChanges(r, false);
...
function Da(t2, e, n = {}) {
  ...
  return t2.asyncQueue.enqueueAndForget(async () => function(t3, e2, n2, s2, i) {
    const r = new ua2({
      next: (n3) => {
        e2.enqueueAndForget(() => Gu(t3, o)), n3.fromCache && s2.source === "server" ? i.reject(new L2(B2.UNAVAILABLE, 'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')) : i.resolve(n3);
      },
      error: (t4) => i.reject(t4)
    }), o = new zu(n2, r, {
      includeMetadataChanges: true,
...
var $a2 = class extends Jc2 {
  constructor(t2, e, n, s) {
    super(t2, e, n, s), this.type = "firestore", this._queue = new ka(), this._persistenceKey = (s == null ? void 0 : s.name) || "[DEFAULT]";
  }
  _terminate() {
...
function Ka(t2, e) {
  ...
  return Qa2(n, i, new $c2(i, s.cacheSizeBytes, e == null ? void 0 : e.forceOwnership));
}
function Ga(t2) {
  Za(t2 = jc2(t2, $a2));
...
var oh = class {
  ...
  toMutation(t2, e) {
    return this.fieldMask !== null ? new Gn(t2, this.data, this.fieldMask, e, this.fieldTransforms) : new Kn(t2, this.data, e, this.fieldTransforms);
  }
};
var uh = class {
  constructor(t2, e, n) {
...
var ah = class {
  constructor(t2, e, n, s, i, r) {
    this.settings = t2, this.databaseId = e, this.It = n, this.ignoreUndefinedProperties = s, i === void 0 && this.na(), this.fieldTransforms = i || [], this.fieldMask = r || [];
  }
  get path() {
...
var mh = class extends sh {
  ...
  _toFieldTransform(t2) {
    const e = _h(this, t2, true), n = this._a.map((t3) => Eh(t3, e)), s = new bn(n);
...
var gh = class extends sh {
  ...
  _toFieldTransform(t2) {
    const e = _h(this, t2, true), n = this._a.map((t3) => Eh(t3, e)), s = new vn(n);
    return new xn(t2.path, s);
  }
  isEqual(t2) {
    return this === t2;
...
function Eh(t2, e) {
  if (Rh(t2 = getModularInstance(t2)))
...
function Rh(t2) {
  return !(typeof t2 != "object" || t2 === null || t2 instanceof Array || t2 instanceof Date || t2 instanceof nt || t2 instanceof ih || t2 instanceof th || t2 instanceof Xc2 || t2 instanceof sh);
}
function bh(t2, e, n) {
  if (!Rh(n) || !function(t3) {
...
function Ph(t2, e, n) {
  ...
  if (typeof e == "string")
    return Vh(t2, e);
  throw Sh("Field path arguments must be of type string or ", t2, false, void 0, n);
}
var vh = new RegExp("[~\\*/\\[\\]]");
function Vh(t2, e, n) {
  if (e.search(vh) >= 0)
    throw Sh(`Invalid field path (${e}). Paths must not contain '~', '*', '/', '[', or ']'`, t2, false, void 0, n);
  try {
    return new eh(...e.split("."))._internalPath;
  } catch (s) {
    throw Sh(`Invalid field path (${e}). Paths must not be empty, begin with '.', end with '.', or contain '..'`, t2, false, void 0, n);
  }
}
...
function Nh(t2, e) {
  return typeof e == "string" ? Vh(t2, e) : e instanceof eh ? e._internalPath : e._delegate._internalPath;
}
function kh(t2) {
  ...
  _apply(t2) {
    const e = lh(t2.firestore), n = function(t3, e2, n2, s, i, r, o) {
      ...
      if (i.isKeyField()) {
        ...
        r !== "in" && r !== "not-in" && r !== "array-contains-any" || Xh(o, r), u = Th(n2, e2, o, r === "in" || r === "not-in");
...
function Qh(...t2) {
  return new Gh("startAt", t2, true);
}
function jh(...t2) {
  return new Gh("startAfter", t2, false);
}
...
function zh(...t2) {
  return new Wh("endBefore", t2, false);
}
function Hh(...t2) {
...
var il = class extends Ch {
  ...
  data(t2 = {}) {
    if (this._document) {
      if (this._converter) {
        const e = new rl(this._firestore, this._userDataWriter, this._key, this._document, this.metadata, null);
...
function cl(t2, e) {
  return t2 instanceof il && e instanceof il ? t2._firestore === e._firestore && t2._key.isEqual(e._key) && (t2._document === null ? e._document === null : t2._document.isEqual(e._document)) && t2._converter === e._converter : t2 instanceof ol && e instanceof ol && (t2._firestore === e._firestore && ra2(t2.query, e.query) && t2.metadata.isEqual(e.metadata) && t2._snapshot.isEqual(e._snapshot));
}
function al(t2) {
  t2 = jc2(t2, Xc2);
...
function ll(t2) {
  ...
  return va2(n, t2._key).then((n2) => new il(e, s, t2._key, n2, new sl(n2 !== null && n2.hasLocalMutations, true), t2.converter));
}
function fl(t2) {
  t2 = jc2(t2, Xc2);
  const e = jc2(t2.firestore, $a2);
...
function ml(t2, e, n) {
  ...
  return El(s, [fh(lh(s), "setDoc", t2._key, i, t2.converter !== null, n).toMutation(t2._key, On.none())]);
}
function gl(t2, e, n, ...s) {
  t2 = jc2(t2, Xc2);
  const i = jc2(t2.firestore, $a2), r = lh(i);
  let o;
  o = typeof (e = getModularInstance(e)) == "string" || e instanceof eh ? Ih(r, "updateDoc", t2._key, e, n, s) : ph(r, "updateDoc", t2._key, e);
...
function pl(t2, e) {
  ...
  return El(n, [fh(lh(t2.firestore), "addDoc", s._key, i, t2.converter !== null, {}).toMutation(s._key, On.exists(false))]).then(() => s);
}
function Il(t2, ...e) {
  var n, s, i;
  ...
  typeof e[o] != "object" || Oa2(e[o]) || (r = e[o], o++);
  const u = {
...
var vl = class {
  ...
  set(t2, e, n) {
    ...
    const s = Vl(t2, this._firestore), i = el(s.converter, e, n), r = fh(this._dataReader, "WriteBatch.set", s._key, i, s.converter !== null, n);
  ...
  update(t2, e, n, ...s) {
    ...
    let r;
    return r = typeof (e = getModularInstance(e)) == "string" || e instanceof eh ? Ih(this._dataReader, "WriteBatch.update", i._key, e, n, s) : ph(this._dataReader, "WriteBatch.update", i._key, e), this._mutations.push(r.toMutation(i._key, On.exists(true))), this;
  }
  delete(t2) {
    this._verifyNotCommitted();
...
var Sl = class extends class {
  ...
  set(t2, e, n) {
    const s = Vl(t2, this._firestore), i = el(s.converter, e, n), r = fh(this._dataReader, "Transaction.set", s._key, i, s.converter !== null, n);
    return this._transaction.set(s._key, r), this;
  }
  update(t2, e, n, ...s) {
    const i = Vl(t2, this._firestore);
    let r;
    return r = typeof (e = getModularInstance(e)) == "string" || e instanceof eh ? Ih(this._dataReader, "Transaction.update", i._key, e, n, s) : ph(this._dataReader, "Transaction.update", i._key, e), this._transaction.update(i._key, r), this;
  }
  delete(t2) {
    const e = Vl(t2, this._firestore);
  ...
  get(t2) {
    ...
    return super.get(t2).then((t3) => new il(this._firestore, n, e._key, t3._document, new sl(false, false), e.converter));
  }
};
function Dl(t2, e, n) {
  t2 = jc2(t2, $a2);
...
function Fl(t2, e) {
  ...
  if (!((n = s.offlineComponents) === null || n === void 0 ? void 0 : n.indexBackfillerScheduler))
    return N2("Cannot enable indexes when persistence is disabled"), Promise.resolve();
  const i = function(t3) {
    const e2 = typeof t3 == "string" ? function(t4) {
      var e3;
      try {
        return JSON.parse(t4);
      } catch (t5) {
        throw new L2(B2.INVALID_ARGUMENT, "Failed to parse JSON: " + ((e3 = t5) === null || e3 === void 0 ? void 0 : e3.message));
      }
    }(t3) : t3, n2 = [];
      ...
      for (const t4 of e2.indexes) {
        ...
        if (Array.isArray(t4.fields))
          for (const e4 of t4.fields) {
            ...
            e4.arrayConfig === "CONTAINS" ? s2.push(new dt(t5, 2)) : e4.order === "ASCENDING" ? s2.push(new dt(t5, 0)) : e4.order === "DESCENDING" && s2.push(new dt(t5, 1));
          }
